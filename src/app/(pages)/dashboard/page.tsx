...
const page = (props: Props) => {
  return (
    <div>
      <h1 className="text-3xl font-bold mt-10">Your Courses</h1>
      <h2 className="text-1xl font-bold mt-10">Degree Courses</h2>
      <div className="mt-8 gap-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        {/* card */}
        <h2 className="text-1xl font-bold mt-10">Certification Courses</h2>
        <div></div>
        <div className="border p-4 rounded-xl">
          <Image src={"/image.png"} className="rounded-xl w-full h-fit" width={200} height={200} alt="image" />
          <div className="flex justify-between items-center mt-4">
